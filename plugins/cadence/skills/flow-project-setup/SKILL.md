...
description: |
  ...
  DO NOT TRIGGER when: writing Cadence code or asking about syntax (use cadence-lang), building token contracts (use cadence-tokens), composing DeFi transactions (use cadence-defi-actions), querying on-chain data (use flow-cli-query), generating new contracts (use cadence-scaffold), auditing code (use cadence-audit).
---
